...
| Opening or merging a pull request to `main` — review locally with Grok Build first, post the verdict on the PR; no bot review, no required checks | `docs/agents/pr-review.md` |
