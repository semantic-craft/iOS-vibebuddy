...
struct QwenRealtimeSessionTests {
    ...
    @Test("a workspace ID or model ID that is not a plain identifier yields no endpoint")
    func rejectsBadIdentifiers() {
        #expect(QwenRealtimeSession.endpoint(model: "qwen-audio-3.0-realtime-plus", workspaceID: "llm abc", useIntl: false) == nil)
        #expect(QwenRealtimeSession.endpoint(model: "qwen-audio-3.0-realtime-plus", workspaceID: "llm%2Fabc", useIntl: false) == nil)
        #expect(QwenRealtimeSession.endpoint(model: "qwen-audio-3.0-realtime-plus", workspaceID: "", useIntl: false) == nil)
