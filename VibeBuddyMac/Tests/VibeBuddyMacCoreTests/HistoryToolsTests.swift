...
final class HistoryToolsTests: XCTestCase {
    ...
    func testRegistryAndCLIParity() throws {
        ...
        XCTAssertEqual(definitions.compactMap { $0["name"] as? String }, ["vibebuddy_get_session", "vibebuddy_get_summary", "vibebuddy_list_sessions", "vibebuddy_list_projects", "vibebuddy_search"])
