...
See [integrated acceptance](https://github.com/semantic-craft/iOS-vibebuddy/blob/v1.3.22/docs/qa/release-1.3.22.md) for the earlier build 35 evidence and [build 36 release verification](https://github.com/semantic-craft/iOS-vibebuddy/blob/v1.3.22/docs/qa/release-1.3.22-build36.md) for the final release candidate. Earlier installed-build evidence does not establish installation acceptance for build 36.
