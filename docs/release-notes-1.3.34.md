...
- 任务面板侧栏和刘海上的几处小字加大到 10pt，朗读控制按钮的点击区域加大；刘海新增「展开速览」操作，VoiceOver 和全键盘操作都能用。
...
- Several small labels in the dashboard sidebar and the notch are now 10 pt, read-aloud controls have larger hit areas, and the notch has a new "Expand glance" action for VoiceOver and Full Keyboard Access.
