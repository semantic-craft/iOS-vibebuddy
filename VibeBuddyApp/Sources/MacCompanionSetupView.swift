...
struct MacCompanionSteps: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            step("2", "Show the pairing code", "On your Mac, open Devices & connection and choose Show connection code. Use the same local network, or connect both devices to Tailscale for remote access.")
